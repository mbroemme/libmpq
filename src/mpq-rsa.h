...
int32_t libmpq__rsa_weak_key_validate(const uint8_t *key, size_t key_size);
int32_t libmpq__rsa_strong_key_validate(const uint8_t *key, size_t key_size);
int32_t libmpq__rsa_weak_operation(
    const uint8_t key[LIBMPQ_RSA_KEY_SIZE], const uint8_t input[LIBMPQ_RSA_SIZE],
    uint8_t output[LIBMPQ_RSA_SIZE]
);
int32_t libmpq__rsa_strong_public_operation(
...
int32_t libmpq__rsa_strong_private_operation(
    const uint8_t key[LIBMPQ_RSA_STRONG_KEY_SIZE], const uint8_t input[LIBMPQ_RSA_STRONG_SIZE],
    uint8_t output[LIBMPQ_RSA_STRONG_SIZE]
);
void
